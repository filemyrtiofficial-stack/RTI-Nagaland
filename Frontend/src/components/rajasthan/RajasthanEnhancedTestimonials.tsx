...
const testimonials = [
  {
    quote: "I needed official information related to press accreditation guidelines. FileMyRTI helped me file the RTI correctly. The reply provided clear instructions.",
    name: "Temjen Ao",
    location: "Nagaland",
    role: "Media Assistant",
    image: "/images/Temjen Ao.webp"
  },
  {
    quote: "I was seeking utilization reports related to program funding. FileMyRTI guided me through the RTI process. The records were shared properly.",
    name: "Abeni Sema",
    location: "Nagaland",
    role: "Program Coordinator",
    image: "/images/Abeni Sema.webp"
  },
  {
    quote: "I needed access to archival government records for research purposes. FileMyRTI assisted me in filing the RTI. The information was provided officially.",
    name: "Vekuto Zhimomi",
    location: "Nagaland",
    role: "Research Scholar",
    image: "/images/Vekuto Zhimomi.webp"
  }
];
        ...
        <AnimatedSection animation="fadeIn" delay={200}>
          <div className="text-center mb-12">
            ...
            <p className="text-base md:text-lg font-normal text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Thousands of Nagaland citizens have successfully obtained government 
