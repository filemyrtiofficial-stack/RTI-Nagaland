...
const detectState = (departmentName: string): string => {
  // Check for Nagaland in department name
  if (departmentName.toLowerCase().includes('nagaland')) {
    return 'nagaland';
  }
  // Default to current state (Nagaland)
  return 'nagaland';
};
...
const departmentToPDFMap: PDFMapping = {
  ...
  // ========== Nagaland DEPARTMENTS ==========
  // All Nagaland PDFs are in: /assets/PDF/RTI_Jammu_and_Kashmir_FULL_CERTIFIED_FINAL/
  // Organized in subfolders by category
  

  // ========== NAGALAND DEPARTMENTS ==========
  // All Nagaland PDFs are in: /assets/PDF/
  'RTI Nagaland Agriculture Department': 'RTI_Nagaland_Agriculture_Department.pdf',
  'RTI Nagaland Animal Husbandry & Veterinary Department': 'RTI_Nagaland_Animal_Husbandry_&_Veterinary_Department.pdf',
  'RTI Nagaland Election Department': 'RTI_Nagaland_Election_Department.pdf',
  'RTI Nagaland Finance Department': 'RTI_Nagaland_Finance_Department.pdf',
  'RTI Nagaland Forest, Environment & Climate Change Department': 'RTI_Nagaland_Forest,_Environment_&_Climate_Change_Department.pdf',
  'RTI Nagaland General Administration Department': 'RTI_Nagaland_General_Administration_Department.pdf',
  'RTI Nagaland Health & Family Welfare Department': 'RTI_Nagaland_Health_&_Family_Welfare_Department.pdf',
  'RTI Nagaland Higher Education Department': 'RTI_Nagaland_Higher_Education_Department.pdf',
  'RTI Nagaland Home Department': 'RTI_Nagaland_Home_Department.pdf',
  'RTI Nagaland Horticulture Department': 'RTI_Nagaland_Horticulture_Department.pdf',
  'RTI Nagaland Industries & Commerce Department': 'RTI_Nagaland_Industries_&_Commerce_Department.pdf',
  'RTI Nagaland Information & Public Relations Department': 'RTI_Nagaland_Information_&_Public_Relations_Department.pdf',
  'RTI Nagaland Information Technology & Communication Department': 'RTI_Nagaland_Information_Technology_&_Communication_Department.pdf',
  'RTI Nagaland Labour & Employment Department': 'RTI_Nagaland_Labour_&_Employment_Department.pdf',
  'RTI Nagaland Law & Justice Department': 'RTI_Nagaland_Law_&_Justice_Department.pdf',
  'RTI Nagaland Planning & Coordination Department': 'RTI_Nagaland_Planning_&_Coordination_Department.pdf',
  'RTI Nagaland Police Department': 'RTI_Nagaland_Police_Department.pdf',
  'RTI Nagaland Power Department': 'RTI_Nagaland_Power_Department.pdf',
  'RTI Nagaland Public Health Engineering Department': 'RTI_Nagaland_Public_Health_Engineering_Department.pdf',
  'RTI Nagaland Public Works Department': 'RTI_Nagaland_Public_Works_Department.pdf',
  'RTI Nagaland Registration & Stamps Department': 'RTI_Nagaland_Registration_&_Stamps_Department.pdf',
  'RTI Nagaland Revenue Department': 'RTI_Nagaland_Revenue_Department.pdf',
  'RTI Nagaland Rural Development Department': 'RTI_Nagaland_Rural_Development_Department.pdf',
  'RTI Nagaland School Education Department': 'RTI_Nagaland_School_Education_Department.pdf',
  'RTI Nagaland Social Welfare Department': 'RTI_Nagaland_Social_Welfare_Department.pdf',
  'RTI Nagaland Taxation Department': 'RTI_Nagaland_Taxation_Department.pdf',
  'RTI Nagaland Technical Education Department': 'RTI_Nagaland_Technical_Education_Department.pdf',
  'RTI Nagaland Tourism Department': 'RTI_Nagaland_Tourism_Department.pdf',
  'RTI Nagaland Transport Department': 'RTI_Nagaland_Transport_Department.pdf',
  'RTI Nagaland Tribal Affairs Department': 'RTI_Nagaland_Tribal_Affairs_Department.pdf',
  'RTI Nagaland Urban Development Department': 'RTI_Nagaland_Urban_Development_Department.pdf',
  'RTI Nagaland Women Resource Development Department': 'RTI_Nagaland_Women_Resource_Development_Department.pdf',
  'RTI Nagaland Youth Resources & Sports Department': 'RTI_Nagaland_Youth_Resources_&_Sports_Department.pdf',
};

/**
 * Get the state from a department name
 * @param departmentName - The display name of the department
 * @returns The state name ('telangana', 'nagaland', or 'delhi')
 */
